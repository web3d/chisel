 ...
 *  optimization is complete, RightBrace can be replaced by ErrorElement.
 *
 ...
 *  @since           1.0
 */
public class RightBrace extends SingleTokenElement {
	public RightBrace( int tokenOffset, TokenEnumerator v ) {
		super( tokenOffset );
