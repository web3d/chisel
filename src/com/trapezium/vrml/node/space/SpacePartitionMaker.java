...
/** The SpacePartitionMaker is used to partition space.  This one is the simplest case
 *  where space is partitioned into even units.
 */
public class SpacePartitionMaker extends PartitionMaker {
    float dx;
    float dy;
    float dz;

    public SpacePartitionMaker( SpaceEntitySet spaceEntitySet, int xSlice, int ySlice, int zSlice ) {
