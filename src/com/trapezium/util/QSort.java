...
/** Trapezium modifications, convert to float sorting */
...
public class QSort
{
   ...
   */
  static void QuickSort(float a[], int lo0, int hi0) throws Exception
    {
      int lo = lo0;
      int hi = hi0;
      float mid;
  ...
  public static final void sort(float a[]) throws Exception
    {
